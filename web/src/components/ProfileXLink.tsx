      ...
      {xHandle ? (
        <div className="profile-x-linked">
          ...
          <p className="muted token-fee-note">
            Launches posted from @{xHandle} will appear on your profile.
          </p>
          <button
            type="button"
        ...
        <div className="profile-x-unlinked">
          <p className="muted">
            Link your X account to attribute @bankrbot launches to your hood.markets profile.
          </p>
          ...
          <p className="muted token-fee-note">
            This is a self-attestation — enter the X handle you use to launch tokens with @bankrbot.
          </p>
          <button
            type="button"

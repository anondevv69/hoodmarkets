...
/** HoodMarkets V3 factory on Robinhood mainnet (v0.6.0 — buyer reward pool). */
export const HOODMARKETS_V3_FACTORY = '0x7E2905ddF3Dca96117A9e9d50F2924C1E7FE7Be1';

/** All production V3 factories — v0.5 tokens remain valid in catalog/UI. */
